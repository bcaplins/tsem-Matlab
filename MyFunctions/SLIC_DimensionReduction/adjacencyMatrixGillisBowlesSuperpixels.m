function A = adjacencyMatrixGillisBowlesSuperpixels(varargin)
% adjacencyMatrixGillisBowlesSuperpixels - construct adjacency matrix from 
%   superpixels of an image using Gillis-Bowles algorithm
% usage: A = adjacencyMatrixGillisBowlesSuperpixels(LabData,BHistData,supPixPosition,rad,sigmaF,sigmaP);
%
% arguments:
...
theta = squareform(acos(1 - pdist(LabData,'cosine')));
meanLabWeight = exp(-theta(DMask));
